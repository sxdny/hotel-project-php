...
<section class="container-fluid my-5 pt-5 d-flex flex-column gap-3 justify-content-center">
    ...
    foreach($habitaciones as $habitacion) {
        ?>
        <form class="row mx-5" action="<?php echo $root.'/forms/reservation/form_insert_reservation.php' ?>"
            method="POST">

            <div class="col card mb-3 px-0" style="min-width: 20rem;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="<?php echo $root.$habitacion['imagen'] ?>" class="img-fluid rounded-start w-100 h-100"
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
